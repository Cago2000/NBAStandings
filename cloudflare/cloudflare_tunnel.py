...
class CloudflareTunnel:
    def __init__(self, tunnel_name, verbose=False):
    ...
    def _find_credentials(self):
        if not self.config_dir.exists():
            print(f"ERROR: {self.config_dir} directory does not exist.")
            return None
        ...
        print("ERROR: No tunnel credentials file found in ~/.cloudflared/")
        return None
    ...
    def start_tunnel(self):
        ...
        if self.credentials_file is None:
            print("ERROR: No credentials file detected. Run `cloudflared tunnel login` first.")
            return
        ...
        while True:
            ...
            try:
                ...
                print("Tunnel exited unexpectedly. Restarting in 5 seconds...")
                time.sleep(5)

            except Exception as e:
                print(f"Exception while starting tunnel: {e}")
                time.sleep(5)
